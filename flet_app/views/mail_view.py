...
class MailView(ft.UserControl):
    ...
    def build(self):
        return ft.Container(
            content=ft.Column([
                ...
                ft.Container(
                    content=ft.Column([
                        self.create_mail_item("john@example.com", "会議の件", "来週の会議についてご連絡いたします...", "2025-07-12 10:30"),
                        self.create_mail_item("alice@example.com", "プロジェクト進捗", "プロジェクトの進捗状況を報告します...", "2025-07-12 09:15"),
                        self.create_mail_item("bob@example.com", "お疲れさまです", "いつもお疲れさまです。今日は...", "2025-07-11 18:45"),
    ...
    def open_mail(self, e):
        # TODO: メール詳細表示実装
        self.page.show_snack_bar(ft.SnackBar(content=ft.Text("メール詳細画面は実装予定です")))